...
parser.add_argument('--n_labels', type=int, default=1,help='number of classes') # 分割肝脏则置为2（二类分割），分割肝脏和肿瘤则置为3（三类分割）
...
parser.add_argument('--win_width', type=float, default=800.0, help='')
parser.add_argument('--win_level', type=float, default=300.0, help='')
...
parser.add_argument('--sample_num', type=int, default=6, help="numbers of sample on every data")

# test
parser.add_argument('--test_cut_size', type=int, default=160, help='size of sliding window')
parser.add_argument('--test_cut_stride', type=int, default=154, help='stride of sliding window')
